...
export default function Privacy() {
  return (
    <>
      <Head>
        <title>Portal Dev | Política de privacidade</title>
      </Head>
      <main>
        <>
          <div className={styles.container}>
            <section>
              <article>
                ...
                <p>
                  No Portal Catalão Internet Services Ltda. privacidade e
                  segurança são prioridades e nos comprometemos com a
                  transparência do tratamento de dados pessoais dos nossos
                  usuários/clientes. Por isso, esta presente Política de
                  Privacidade estabelece como é feita a coleta, uso e
                  transferência de informações de clientes ou outras pessoas que
                  acessam ou usam nosso site. Ao utilizar nossos serviços, você
                  entende que coletaremos e usaremos suas informações pessoais
                  ...
                  Portal Catalão Internet Services Ltda., doravante denominada
                  simplesmente como “Portal Catalão”, inscrita no CNPJ/MF sob o
                  nº 07.156.505/0001-99, no papel de Controladora de Dados,
              ...
              <article>
                ...
                <p>
                  <strong>Dados pessoais fornecidos pelo titular</strong>
                  <br />
                ...
                <p>
                  ...
                  <br />
                  Atualmente o site Portal Catalão não coleta nenhum dado
                  fornecido pelo usuário em nenhum meio de interação com a
                  plataforma.
                </p>
              </article>
              ...
              <article>
                ...
                <p>
                  ...
                  inequívoca pela qual você autoriza a Portal Catalão a tratar
                  ...
                  transparência e boa-fé da Portal Catalão para com seus
                  usuários/clientes, seguindo as regulações legislativas
                  pertinentes. Ao utilizar os serviços da Portal Catalão e
              ...
              <article>
                ...
                <p>
                  A Portal Catalão assegura a seus usuários/clientes seus
                  direitos de titular previstos no artigo 18 da Lei Geral de
                  Proteção de Dados. Dessa forma, você pode, de maneira gratuita
                  e a qualquer tempo:
                  <br />
                </p>
                ...
                <ul>
                  ...
                  <li>
                    <strong>Acessar seus dados</strong>, podendo solicitá-los em
                    uma cópia legível sob forma impressa ou por meio eletrônico,
                    seguro e idôneo.
                  </li>
                  <li>
                    <strong>Corrigir seus dados</strong>, ao solicitar a edição,
                    correção ou atualização destes.
                  </li>
                  <li>
                    <strong>Limitar seus dados aquando desnecessários</strong>,
                    excessivos ou tratados em desconformidade com a legislação
                    através da anonimização, bloqueio ou eliminação.
                  </li>
                  <li>
                    <strong>Solicitar a portabilidade de seus dados</strong>,
                    através de um relatório de dados cadastrais que a Portal
                    Catalão trata a seu respeito.
                  </li>
                  <li>
                    <strong>Eliminar seus dados</strong> tratados a partir de
                    seu consentimento, exceto nos casos previstos em lei.
                  </li>
                  <li>
                    <strong>Revogar seu consentimento</strong>, desautorizando o
              ...
              <article>
                ...
                <p>
                  ...
                  contato com a Portal Catalão através dos seguintes meios
                  disponíveis:{" "}
                  <strong>
                    {" "}
                    comercial@portalcatalao.com.br ou (64) 3411-0748
                  </strong>
                  <br />
              ...
              <article>
                ...
                <p>
                  Seus dados pessoais coletados pelo Portal Catalão serão
                ...
                <p>
                  ...
                  contratual entre você e a Portal Catalão perdurar. Findado o
                ...
                <p>
                  O armazenamento de dados coletados pelo Portal Catalão reflete
                  o nosso compromisso com a segurança e privacidade dos seus
              ...
              <article>
                ...
                <p>
                  O Portal Catalão se compromete a adotar as melhores posturas
                  para evitar incidentes de segurança. Contudo, é necessário
                  destacar que nenhuma página virtual é inteiramente segura e
                  livre de riscos. É possível que, apesar de todos os nossos
                  protocolos de segurança, problemas de culpa exclusivamente de
                  terceiros ocorram, como ataques cibernéticos de hackers, ou
                  também em decorrência da negligência ou imprudência do próprio
                  usuário/cliente.
                </p>
              ...
              <article>
                ...
                <p>
                  Tendo em vista a preservação de sua privacidade, a Portal
                  Catalão não compartilhará seus dados pessoais com nenhum
                ...
                <ul>
                  ...
                  <li>
                    ...
                    simplificado) em qualquer tipo de conflito, inclusive os de
                    teor judicial.
                  </li>
                </ul>
                ...
                <p>
                  ...
                  às demais legislações brasileiras de proteção de dados.
                  instrumento.
                </p>
                <p>
                  Nesse sentido, a Portal Catalão se compromete a sempre adotar
              ...
              <article>
                ...
                <p>
                  O Portal Catalão faz uso de Cookies, que são arquivos de texto
                  ...
                  experiência de uso. Ao acessar nosso site e consentir com o
                  uso de Cookies, você manifesta conhecer e aceitar a utilização
                  de um sistema de coleta de dados de navegação com o uso de
                  Cookies em seu dispositivo.
                </p>
                <p>
                  <strong>
                    O Portal Catalão utiliza os seguintes Cookies:{" "}
                  </strong>
                </p>
                <p>
              ...
              <article>
                ...
                <p>
                  ...
                  atualizada pela última vez em: 20 de julho de 2022. Reservamos
              ...
              <article>
                ...
                <p>
                  A Portal Catalão prevê a responsabilidade dos agentes que
                  atuam nos processos de tratamento de dados, em conformidade
                  com os artigos 42 ao 45 da Lei Geral de Proteção de Dados. Nos
                  ...
                  buscar condições técnicas e organizativas seguramente aptas a
                  ...
                  Portal Catalão, comprometemo-nos a segui-las.
                </p>
                ...
                <p>
                  ...
                  sentido, a Portal Catalão não se responsabiliza por:
                </p>
                <ul>
                  <li>
                    I – Quaisquer consequências decorrentes da negligência,
                    imprudência ou imperícia dos usuários em relação a seus
                    dados individuais. Garantimos e nos responsabilizamos apenas
                  ...
                  <li>
                    ...
                    exceto se comprovada conduta culposa ou deliberada da Portal
                    Catalão. Destacamos que em caso de incidentes de segurança
                    que possam gerar risco ou dano relevante para você ou
                    qualquer um de nossos usuários/clientes, comunicaremos aos
                    afetados e a Autoridade Nacional de Proteção de Dados sobre
                    o ocorrido e cumpriremos as providências necessárias.
                  </li>

                  <li>
                    III – Inveracidade das informações inseridas pelo
                    usuário/cliente nos registros necessários para a utilização
                    dos serviços da Portal Catalão; quaisquer consequências
                    decorrentes de informações falsas ou inseridas de má-fé são
                    de inteiramente responsabilidade do usuário/cliente.
                  </li>
                </ul>
              </article>
              ...
              <article>
                ...
                <p>
                  A Portal Catalão disponibiliza os seguintes meios para que
                  você possa entrar em contato conosco para exercer seus
                  direitos de titular:{" "}
                  <strong>contato@portalcatalao.com.br.</strong>
                </p>
                <p>
                  Caso tenha dúvidas sobre esta Política de Privacidade ou sobre
                  os dados pessoais que tratamos, você pode entrar em contato
                  com o nosso Encarregado de Proteção de Dados Pessoais, através
                  dos seguintes canais:{" "}
                  <strong>
                    Portal Catalão Internet Service 07.156.505/0001-99 e
                    developer@portalcatalao.com.br
                  </strong>
                </p>
              </article>
            </section>
